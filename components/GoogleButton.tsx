export default function GoogleButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="flex min-h-[52px] w-full items-center justify-center gap-3 rounded-[14px] border border-ink-200 bg-white px-4 text-sm font-extrabold text-ink transition hover:border-ink-300 hover:bg-ink-50 disabled:cursor-not-allowed disabled:opacity-55"
    >
