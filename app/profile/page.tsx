  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (snap.exists()) {
        ...
        setOrganization(d.organization ?? ""); setHiringNeeds(d.hiringNeeds ?? ""); setEducation(typeof d.education === "string" ? d.education : Array.isArray(d.education) ? d.education.map((e: any) => e?.degree || e?.title || e).filter(Boolean).join(", ") : "");
      }
