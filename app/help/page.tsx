...
import { ArrowRight, HelpCircle, Mail, MessageCircle, ShieldCheck, Sparkles } from "lucide-react";
...
const FAQS: { q: string; a: string; href?: string; cta?: string }[] = [
  ...
  },
  {
    ...
    a: "Cancellations follow the platform&#39;s cancellation policy. If a held payment is released back to the client, it appears correctly in your history - we never invent payouts.",
    href: "/#trust",
    cta: "Trust &amp; safety",
  },
  {
      ...
      <div className="page-shell max-w-4xl">
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
          {[
            ...
            { icon: MessageCircle, title: "Contact us", desc: "Message our support team directly from the app.", href: "/messages" },
            { icon: ShieldCheck, title: "Trust & safety", desc: "Guidelines, insurance and cancellation policies.", href: "/#trust" },
            { icon: Mail, title: "Learn more", desc: "Guides and articles on getting started.", href: "/#learn" },
          ].map((card) => (
